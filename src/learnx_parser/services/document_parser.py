...
class DocumentParser:
    ...
    def _generate_background_for_slide(
        self, slide: Slide, slide_number: int
    ) -> str | None:
        ...
        has_background = (
            slide.common_slide_data.background_color
            or slide.common_slide_data.background_gradient_fill
            or slide.common_slide_data.background_reference
            or slide.common_slide_data.background_image_path
        )
        ...
        if self.html_writer.theme_resolver:
            ...
            theme_colors = {
                ...
                "accent1": self.html_writer.theme_resolver.resolve_scheme_color(
                    "accent1"
                ),
                "accent2": self.html_writer.theme_resolver.resolve_scheme_color(
                    "accent2"
                ),
                "accent3": self.html_writer.theme_resolver.resolve_scheme_color(
                    "accent3"
                ),
                "accent4": self.html_writer.theme_resolver.resolve_scheme_color(
                    "accent4"
                ),
                "accent5": self.html_writer.theme_resolver.resolve_scheme_color(
                    "accent5"
                ),
                "accent6": self.html_writer.theme_resolver.resolve_scheme_color(
                    "accent6"
                ),
        ...
        generated_path = self.background_renderer.generate_background_image(
            slide.common_slide_data, background_path, theme_colors
        )
    ...
    def parse_presentation(self):
        ...
        self.background_renderer = BackgroundRenderer(
            slide_width=1280, slide_height=720
        )
