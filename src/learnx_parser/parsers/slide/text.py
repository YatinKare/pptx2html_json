    ...
    for run_element in paragraph_element.findall(
        ...
        if run_text_element is not None and run_text_element.text is not None:
            ...
            run_properties = extract_run_properties(
                ...
                current_level, paragraph_properties_element
            )
...
def extract_run_properties(
    ...
    if not run_properties.font_size:
        resolved_font_size = _resolve_font_size_intelligently(
            parser_instance, paragraph_properties_element, slide_layout_obj, 
            ph_type, paragraph_level
        )
        if resolved_font_size:
            run_properties.font_size = resolved_font_size

    # Apply other property inheritance as needed
    _apply_inherited_run_properties(run_properties, parser_instance, paragraph_properties_element, 
                                   slide_layout_obj, ph_type, paragraph_level)
...
def _resolve_font_size_intelligently(
    parser_instance, paragraph_properties_element, slide_layout_obj: SlideLayout | None, 
    ph_type: str | None, paragraph_level: int | None
) -> int | None:
    ...
    if paragraph_properties_element is not None:
        def_rpr_element = paragraph_properties_element.find(".//a:defRPr", namespaces=parser_instance.nsmap)
    ...
    if slide_layout_obj and paragraph_level is not None:
        if slide_layout_obj.list_styles and paragraph_level in slide_layout_obj.list_styles:
            level_props = slide_layout_obj.list_styles[paragraph_level]
            if (level_props and level_props.default_run_properties and 
                level_props.default_run_properties.font_size is not None):
    ...
    if hasattr(parser_instance, 'presentation_defaults') and parser_instance.presentation_defaults:
        ...
        if effective_level != 0 and 0 in parser_instance.presentation_defaults:
            level_0_props = parser_instance.presentation_defaults[0]
            if (level_0_props and level_0_props.default_run_properties and 
...
def _apply_inherited_run_properties(
    run_properties: RunProperties, parser_instance, paragraph_properties_element,
    slide_layout_obj: SlideLayout | None, ph_type: str | None, paragraph_level: int | None
):
    ...
    if not run_properties.italic:
        inherited_italic = _resolve_run_property_intelligently(
            parser_instance, paragraph_properties_element, slide_layout_obj,
            ph_type, paragraph_level, "italic"
        )
        if inherited_italic:
...
def _resolve_run_property_intelligently(
    parser_instance, paragraph_properties_element, slide_layout_obj: SlideLayout | None,
    ph_type: str | None, paragraph_level: int | None, property_name: str
):
    ...
    if paragraph_properties_element is not None:
        ...
        if def_rpr_element is not None:
            value = _extract_property_from_def_rpr(def_rpr_element, property_name, parser_instance.nsmap)
    ...
    if hasattr(parser_instance, 'presentation_defaults') and parser_instance.presentation_defaults:
        ...
        if effective_level != 0 and 0 in parser_instance.presentation_defaults:
            ...
            if level_0_props and level_0_props.default_run_properties:
                value = getattr(level_0_props.default_run_properties, property_name, None)
                if value is not None:
                    return value
...
def _extract_property_from_def_rpr(def_rpr_element, property_name: str, nsmap):
    ...
    if property_name == "bold":
        ...
        return latin_font_element.get("typeface") if latin_font_element is not None else None
...
def _resolve_font_intelligently(
    ...
    if paragraph_properties_element is not None:
        ...
        if def_rpr_element is not None:
            ...
            font_face = _extract_property_from_def_rpr(def_rpr_element, "font_face", parser_instance.nsmap)
            if font_face:
                return {"font_face": font_face}
            # Check for font reference
            font_ref = _extract_property_from_def_rpr(def_rpr_element, "font_ref", parser_instance.nsmap)
            if font_ref:
