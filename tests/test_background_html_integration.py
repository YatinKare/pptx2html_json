...
class TestBackgroundHtmlIntegration:
    ...
    def test_background_css_with_generated_image(self):
        ...
        slide = Slide(
            slide_number=1, generated_background_path="media/background_1.png"
        )
    ...
    def test_multiple_slides_different_backgrounds(self):
        ...
        slides = [
            Slide(slide_number=1, generated_background_path="media/background_1.png"),
            Slide(slide_number=2, generated_background_path="media/background_2.png"),
            Slide(
                slide_number=3,
                generated_background_path=None,
                common_slide_data=CommonSlideData(background_color="FF0000"),
    ...
    def test_background_image_path_format(self):
        ...
        for path in test_cases:
            slide = Slide(slide_number=1, generated_background_path=path)
    ...
    def test_css_properties_completeness(self):
        ...
        slide = Slide(
            slide_number=1, generated_background_path="media/test_background.png"
        )
